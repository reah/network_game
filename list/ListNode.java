...
public abstract class ListNode {
   ...
   *  Performance:  runs in O(1) time.
   */
  public int item() throws InvalidNodeException {
    if (!isValidNode()) {
   ...
   *  Performance:  runs in O(1) time.
   */
  public void setItem(int item) throws InvalidNodeException {
    if (!isValidNode()) {
      throw new InvalidNodeException();
    }
    this.item = item;
   ...
   *  @exception InvalidNodeException if this node is not valid.
   */
  public abstract void insertAfter(int item, int x, int y) throws InvalidNodeException;
   ...
   *  @exception InvalidNodeException if this node is not valid.
   */
  public abstract void insertBefore(int item, int x, int y) throws InvalidNodeException;
